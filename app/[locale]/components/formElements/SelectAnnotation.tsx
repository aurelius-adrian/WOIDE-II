                ...
                <div className={"flex flex-col gap-0.5"}>
                    <Accordion collapsible={true} className={"-ml-3"}>
                        <AccordionItem value="1">
                            <AccordionHeader expandIconPosition="end" expandIcon={<InfoRegular/>} className={"h-7"}>
                    ...
                    <div className={"flex flex-row gap-x-0.5 py-2"}>
                        <Button onClick={() => select(field.onChange)}>{t("select")}</Button>
                        <Button onClick={() => highlight(field.value)} appearance={"transparent"} icon={<EyeFilled/>}/>
                    </div>
